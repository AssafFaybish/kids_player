...
export const ADD_GUIDE_SLIDES = [
  ...
  {
    img: 'assets/guide/sheet-01-what.svg', title: 'דרך 3: קובץ הגיליון בגוגל דרייב',
    text: 'זו הרשימה הראשית. כל שורה בקובץ = סרטון אחד או ערוץ אחד. הקובץ נוח כשרוצים להוסיף הרבה בבת אחת, מהמחשב, או לשתף את אותה רשימה בין כמה מכשירים וילדים.'
  },
  {
    img: 'assets/guide/sheet-02-paste.svg', title: 'פשוט מדביקים לינק בשורה חדשה',
    text: 'מעתיקים לינק מיוטיוב, פותחים את הקובץ, מדביקים בשורה ריקה בעמודה הראשונה — וזהו. אפשר להוסיף שם לסרטון בעמודה השנייה, אבל זה לא חובה.'
  },
  {
